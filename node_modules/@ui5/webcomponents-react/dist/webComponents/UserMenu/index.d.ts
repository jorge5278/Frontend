...
interface UserMenuPropTypes extends UserMenuAttributes, Omit<CommonProps, keyof UserMenuAttributes | 'accounts' | 'children' | 'onAddAccountClick' | 'onAvatarClick' | 'onChangeAccount' | 'onClose' | 'onItemClick' | 'onManageAccountClick' | 'onOpen' | 'onSignOutClick'> {
    /**
