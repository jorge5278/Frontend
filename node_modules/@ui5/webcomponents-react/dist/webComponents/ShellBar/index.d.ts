...
interface ShellBarPropTypes extends ShellBarAttributes, Omit<CommonProps, keyof ShellBarAttributes | 'assistant' | 'children' | 'content' | 'logo' | 'menuItems' | 'profile' | 'searchField' | 'startButton' | 'onContentItemVisibilityChange' | 'onLogoClick' | 'onMenuItemClick' | 'onNotificationsClick' | 'onProductSwitchClick' | 'onProfileClick' | 'onSearchButtonClick'> {
    /**
