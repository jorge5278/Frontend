...
import type { DialogDomRef } from '../../webComponents/index.js';
...
interface FilterDialogPropTypes {
    ...
    handleDialogSave: (e: any, selectionChangePayload: any, orderedChildren: any) => void;
...
export declare const FilterDialog: (props: FilterDialogPropTypes) => import("react/jsx-runtime").JSX.Element;
export {};
