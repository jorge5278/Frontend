...
interface UserMenuItemPropTypes extends UserMenuItemAttributes, Omit<CommonProps, keyof UserMenuItemAttributes | 'children' | 'deleteButton' | 'endContent' | 'onBeforeClose' | 'onBeforeOpen' | 'onClose' | 'onDetailClick' | 'onOpen'> {
    /**
